...
#include "../../../Dokumente/repos/game/src/movebutton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_movebutton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 22, 11)
    ...
    "movebutton\0clicked\0\0i\0slotclicked\0"
};
...
void movebutton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotclicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (movebutton::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&movebutton::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject movebutton::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_movebutton.data,
      qt_meta_data_movebutton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_movebutton.stringdata))
...
// SIGNAL 0
void movebutton::clicked(int _t1)
{
